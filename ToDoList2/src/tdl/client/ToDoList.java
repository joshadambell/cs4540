...
public class ToDoList implements EntryPoint {
	...
	private void displayApp () {
		...
		horizontalPanel_1.setWidth("150px");
		horizontalPanel_2.setWidth("100px");
		...
		Anchor allTasks = new Anchor(true);
		horizontalPanel_1.add(allTasks);
		allTasks.setHTML("All Tasks");
		logout.setHref("google.com");
